...
class UsersCollection(BaseModel):
    userId: str = Field(..., description="Internal UserID")
    yearOfBirth: Optional[int] = Field(None, ge=1900, description="Year of birth (must be a four-digit year, not in the future)")
    ...
    health_issues: List[str] = Field(default_factory=list, description="Known  health issues")
